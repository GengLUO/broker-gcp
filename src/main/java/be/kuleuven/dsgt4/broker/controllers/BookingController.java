...
public class BookingController {
    ...
    @Autowired
    public BookingController(TransactionCoordinatorService transactionCoordinatorService) {
    ...
    public ResponseEntity<?> createHotelBooking(@RequestBody String bookingDetails) {
        try {
            String messageId = transactionCoordinatorService.initiateHotelBooking(bookingDetails);
    ...
    public ResponseEntity<?> createFlightBooking(@RequestBody String bookingDetails) {
        try {
            String messageId = transactionCoordinatorService.initiateFlightBooking(bookingDetails);
